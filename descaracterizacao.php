...
.home-banner-area-out {
    background: url(img/bk4.jpg) center;
			...
			<div class="container">
				<div class="row fullscreen d-flex align-items-center justify-content-between dxrac">
					<div class="home-banner-content banner-out col-lg-12 col-md-12">
						<h1>
							<b style="color:#ffff;" class="titulo-inicial"><b style="color:#00adee">
Descaracterização</b> de Frota  <br>e <b style="color: #00adee">Remoção</b> de Adesivo </b><br>
						</h1>
								</div>
				</div>
			</div>
